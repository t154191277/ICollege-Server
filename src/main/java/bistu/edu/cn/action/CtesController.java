...
@Action(value="ctes",results = {
		@Result(name = "success",type = "redirectAction",params = {"actionName","ctes"})})
@Namespace("/api")
public class CtesController implements ModelDriven<Object>{
	...
	private Collection<Cte> list;
	
	public HttpHeaders index(){
		HttpServletRequest request = ServletActionContext.getRequest();
		String id = request.getParameter("id");
		String token = request.getParameter("token");
		list = cteServiceI.getCteList(id, token);
